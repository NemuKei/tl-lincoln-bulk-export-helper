...
- `D-20260331-001` | 2026-03-31 | repo-wide 運用は `AGENTS.md` を正本としつつ、docs 更新判断、context 反映、verification、事前調査、backlog 棚卸し、thread 整理の 6 Skill を `.agents/skills/` に常設する | `docs/spec_000_overview.md` | active
